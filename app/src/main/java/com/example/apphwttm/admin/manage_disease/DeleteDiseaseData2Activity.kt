...
class DeleteDiseaseData2Activity : AppCompatActivity() {
    ...
    override fun onCreate(savedInstanceState: Bundle?) {
        ...
        setContentView(R.layout.activity_delete_disease_data2)

        var bundle: Bundle? = intent.extras
        var docId: String = bundle!!.getString("send_to_delete_disease_id").toString()
        var itemName: String = bundle!!.getString("send_to_delete_disease_name").toString()
